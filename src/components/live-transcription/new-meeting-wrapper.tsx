...
import { useMeetingContext } from "@/components/live-transcription/hooks/storage-for-live-meeting";
...
export function LiveTranscription() {
  ...
  const { scrollRef } = useAutoScroll(chunks);
      ...
      >
        ...
        >
          ...
          <div className="h-full overflow-hidden">
            <TranscriptionView settings={settings} isLoading={isLoading} />
          </div>
