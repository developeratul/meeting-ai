...
} from "@/components/meeting-history/meeting-utils";
    ...
    try {
      ...
      if (!skipConfirm) {
        const result = await new Promise<boolean>((resolve) => {
          ...
          const dontAskAgain = (document.getElementById("dontAskAgain") as HTMLInputElement)
            ?.checked;
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleNewMeeting} variant="default" size="sm">
